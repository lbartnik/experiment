...
(function () {
  var Data, Position, UI, Widget, Widget2, euclidean, mapNodes;
  ...
  UI = function UI(selection) {
    ...
    ui.on = function (event, callback) {
      ...
      if (event === 'mouseout') {
        return canvas.on("mouseout", callback);
      }
    };
    ui.initialize();
    return ui;
  ...
  Widget = function Widget(selection) {
    var data, lenseR, moveLenses, nodeR, pos, resetScale, setEvents, ui, widget;
    nodeR = 15;
    lenseR = 50;
    ...
    setEvents = function setEvents() {
      ...
      return ui.on('mouseout', resetScale);
    };
    ...
    resetScale = function resetScale(e) {
      data.resetScale();
      return ui.updatePositions();
    };
    return widget;
