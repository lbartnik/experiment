...
(function () {
  var Data, Details, FloatingDescription, Log, Position, UI, Viewport, Widget, euclidean, log, mapNodes, plotHref, sign;
  ...
  Data = function Data(data) {
    var counter, dataObject, setupData;
    ...
    dataObject.filter = function (phrase) {
      data.steps.forEach(function (step) {
        return step.matched = step.name ? step.name.match(phrase) : true;
      });
      dataObject.steps = data.steps.filter(function (step) {
        return step.matched;
      });
      return dataObject.links = data.links.filter(function (link) {
        return link.target.matched && link.source.matched;
      });
    };
