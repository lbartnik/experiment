...
UpdateNodes = function(type, vis, rx, ry) {
...
VariablesNetwork = function(radius, vis) {
  ...
  // transition outside
  variablesNetwork.show = function(timeout = 150) {
    var self;
    if (animation != null) {
      animation.stop();
    }
  ...
  // transition inside
  variablesNetwork.hide = function(timeout = 150) {
    var self;
    if (animation != null) {
      animation.stop();
    }
  ...
  computePosition = function(angle, alpha) {
    var x, y;
...
CommitsNetwork = function(vis, showVariables, hideVariables) {
