...
the notions of a __data artifact__, a __commit__ and a __branch__.
...
Data research in this context
means any activity whose aim is predictive or descriptive modelling. In
the course of data research, an input data set is loaded, cleaned,
transformed and fed into one or model numerical models. The findings are
often reported in 
